...
Ninja-Property-Set uploadSpeedtest $SpeedtestObj.uploadspeed
Ninja-Property-Set downloadSpeedtest $SpeedtestObj.downloadspeed
Ninja-Property-Set packetlossSpeedtest $SpeedtestObj.packetloss
Ninja-Property-Set ispSpeedtest $SpeedtestObj.isp
Ninja-Property-Set latencySpeedtest $SpeedtestObj.latency
